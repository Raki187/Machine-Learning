...
nn <- neuralnet(ClassOne + ClassZero ~ PRE4 + PRE5+PRE7 +PRE8+ PRE9+ PRE10 +PRE11 +PRE17 +PRE19+PRE25+PRE30+PRE32+AGE , data=nnet_train, hidden=0 , err.fct="sse",linear.output = FALSE ,threshold=0.009)
